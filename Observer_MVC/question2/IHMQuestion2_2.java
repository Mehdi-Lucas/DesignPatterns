...
public class IHMQuestion2_2 extends JFrame {
    ...
    public IHMQuestion2_2() {
        ...
        MouseListener jmo1 = new JMouseObserver("jbo1", contenu);
        MouseListener jmo2 = new JMouseObserver("jbo2", contenu);
        MouseListener jmo3 = new JMouseObserver("jbo3", contenu);
